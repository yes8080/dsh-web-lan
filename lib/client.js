				...
				children: [
					...
					open ? react.createElement("div", { className: lanCss.body, children: [
						...
						state.override ? react.createElement("div", { className: lanCss.resetRow, children: [
							react.createElement(primitives.Button, { variant: "ghost", size: "sm", disabled, onClick: props.reset, children: t("resetToConfigured") })
						] }) : null,
						react.createElement("div", { className: lanCss.footer, children: [
							...
							react.createElement(primitives.Button, { variant: "outline", disabled: (!state.dirty && !state.failed) || state.saving, onClick: props.discard, children: t("discard") }),
							react.createElement(primitives.Button, { variant: "primary", disabled: blocked, onClick: props.save, children: t(state.saving ? "saving" : "save") })
						] })
					] }) : null
				]
			});
